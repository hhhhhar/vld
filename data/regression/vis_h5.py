...
def print_h5_tree(h5_path):
    ...
    with h5py.File(h5_path, 'r') as f:
        ...
        cam_mat = f["cam_mat"][:]
        print(cam_mat)
        depth_isaac = f["distance_to_image_plane"][28]
        ...
        seg = f["semantic_segmentation"][28]
...
h5_dir = "/home/hhhar/liuliu/vld/data/regression/data_res"
file_list = sorted(os.listdir(h5_dir))
for file_name in file_list:
    h5_path = osp.join(h5_dir, file_name)
    print(h5_path)
